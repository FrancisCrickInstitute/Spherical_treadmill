...
#define SSF  27   // Slave Select pin for the front sensor.
#define SSL  15   // Slave Select pin for lateral sensor.
...
int ppr = 20000; //Need to calibrate 
